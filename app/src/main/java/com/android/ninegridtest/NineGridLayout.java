    ...
    private void refresh() {
       removeAllViews();
        ...
        if (size == 1) {
            ...
            boolean isShowDefualt = displayOneImage(imageView, url, mTotalWidth,Integer.parseInt(mUrlList.get(0).getPic_width()),Integer.parseInt(mUrlList.get(0).getPic_height()));
            if (isShowDefualt) {
...
//        params.width = width;
     ...
     */
    protected abstract boolean displayOneImage(RatioImageView imageView, String url, int parentWidth,int picWidth,int picHeight);
